            ...
            <div class="main-banner-content">
                <div class="home-slides">
                    <div class="hero-content">
                        <h1><span>ادارۃ العلم </span>میں خوش آمدید </h1>
                        <p>
                    ...
                    <div class="hero-content">
                        ...
                        <p>
                            ...
                            فضلاء مستفید ہوسکیں۔ خاص طور پر سکول وکالجزکے
                        </p>
                        <a href="{{ route('about') }}" class="btn btn-primary">مزید جانتے</a>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <div class="about-content">
                        <h3>تعارف</h3>
                        <p>ہمیں فخر ہے الحمدللہ! تمام دینی درساگاہیں اپنے اکابرین سے ملے روایتی نہج کے مطابق اپنے سائبان وفاق المدارس العربیہ پاکستان کے تحتـ  تعلیمی سفر رواں دواں    رکھے ہوئے ہیں۔</p>
                        <p class="mb-0">البتہ  ضرورتـ اس امر کی ہےکہ مدارسـ کے طلباء میں ہم آہنگی کے فروغ کے لیے ایسا  علمی ماحول پیدا کیا جائے  جس سے تمام طلباءو فضلاء مستفید ہو سکیں۔ خاص طور پر سکول وکالجزکے نوجوان طلباء کو دینی تعلیم سے روشناس کروایا جاسکے۔</p>
                        <p class="mb-0">عوامی حلقوں اور مساجد میں فہم دین کے عنواناتـ پر مختلفـ موضوعاتـ کے کورسز کروائے جائیں گے۔ انہی ضروریاتـ کو مدنظر رکھتے ہوئےمفکرِ اسلام حضرتـ مولانا زاہدالراشدی صاحبـ دامتـ برکاتہم، حضرتـ مولانا ڈاکٹر الیاس فیصل صاحبـ دامتـ برکاتہم مقیم مدینہ منورہ اور حضرت مولانا محمد عبیداللہ عامر صاحبـ دامتـ برکاتہم کی سرپرستی میں الحمد للہ! جون 2022ء کو ادارۃ العلم گوجرانوالہ کا قیام عمل میں لایا گیا۔</p>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="about-content">
                        ...
                        <p>:۔ حفظ القرآن کے لیے جدید طرزتدریس پر مبنی دارالقرآن کا قیام</p>

                        <p class="mb-0">ریسرچ سینٹر کا قیام: جس کے تحتـ علمی موضوعاتـ کی مقالہ جاتـ کی صورتـ میں اشاعتـ۔</p>
                        <p class="mb-0">:۔ دارالتحقیق والارشاد کا قیام: جس کا مقصد روزمرہ زندگی کے درپیش مسائل میں اکابرواسلاف کی تحقیقاتـ کی روشنی میں امتـ کی راہنمائی</p>
                        <p class="mb-0">اہل علم اور مطالعہ کاشوق رکھنے والے عامۃالمسلمین  کے لئےمختلف دینی موضوعاتـ پر لائبریری کا قیام۔</p>
                        <p class="mb-0">مدارس كے طلباء وفضلاء کو ایسے فنون سکھانا جن کی بدولتـ وہ اپنی معاشی مشکلاتـ دور کرسکیں۔</p>
                        <p class="mb-0">دینی و عصری تعلیم کے بیکـ وقتـ حصول کے مواقع فراہم کرنا۔</p>
                    </div>
                </div>
            </div>
        </div>
